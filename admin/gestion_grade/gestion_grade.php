        ...
        <td><form action="gestion_grade.php" method="post" name="race">
            <table width="100%">
                ...
                <tr>
                    ...
                    $liste_race = mysqli_query($conn, "SELECT race_id,nom FROM races WHERE grade_id=-2");
    ...
    <tr>
        <td>
                ...
                if (isset($_POST['race_id']) || isset($_GET['edit_grade'])) {
                    ...
                    $liste_grade = mysqli_query($conn, "SELECT * FROM races WHERE race_id=$race_id");
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <?php
                                    // Affichage des diff�rents choix pour les camps
                                    $liste_camps = mysqli_query($conn, "SELECT race_id,nom FROM races WHERE grade_id=0");
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <?php
                                    // Affichage des diff�rents choix pour les camps
                                    $liste_camps = mysqli_query($conn, "SELECT id,nom FROM camps");
            ...
            <form method="post" action="ControllerGradeEdition.php">
                ...
                <tr>
                    ...
                    <td align="right">
                        <select name="new_race_id">
                            <?php
                            $reponse = mysqli_query($conn, "SELECT race_id,nom FROM races WHERE grade_id = 0");
