    ...
    <tr>
        <td>
            <table>
                ...
                <?php
                $liste_camp = mysqli_query($conn, "SELECT * FROM camps");
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    $liste_cartes = mysqli_query($conn, "SELECT id,nom FROM cartes");
            ...
            <form method="post" action="ControllerCampEdition.php">
                ...
                <tr>
                    ...
                    <td align="right">
                        <select name="id_carte">
                            <?php
                            $reponse = mysqli_query($conn, "SELECT id,nom FROM cartes");
