...
//-- Info personnages
    ...
    $resultat1 = mysqli_query($conn, $info1) or die(mysqli_error($conn));
          ...
          <input name="id_utilisateur" type="hidden" value='<?php echo $id; ?>' />
            <table>
                ...
                <tr>
                    <td>Droits : </td>
                    <td>
                        <input type="checkbox" name="droit1" value="1" <?php if ($droits[0] == 1) {
                            echo 'checked="checked"';
                                                                       }?>> Compte valide<br/>
                        <input type="checkbox" name="droit2" value="1" <?php if ($droits[1] == 1) {
                            echo 'checked="checked"';
                                                                       }?>> Administration<br/>
                        <input type="checkbox" name="droit3" value="1" <?php if ($droits[2] == 1) {
                            echo 'checked="checked"';
                                                                       }?>> Animation<br/>
                        <input type="checkbox" name="droit4" value="1" <?php if ($droits[3] == 1) {
                            echo 'checked="checked"';
                                                                       }?>> Anti-triche<br/>                       
                </tr>
                <tr>
                    ...
                    <td>
                        <ul>
                                <?php
                                    ...
                                    $resultat = mysqli_query($conn, $persos) or die(mysqli_error($conn));
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="ban_check" value="1" <?php if (!empty($infos1['date'])) {
                            echo 'checked="checked"';
                                                                          }?>> Bannir cet utilisateur<br/>
                        <input name="ban_existe" type="hidden" value='<?php if (!empty($infos1['date'])) {
                            echo 'existe';
                                                                      }?>' />
