...
if (isset($_POST['nom_perso'])) {
    $nom_perso = mysqli_real_escape_string($conn, $_POST['nom_perso']);
    mysqli_query($conn, "UPDATE persos SET nom = '$nom_perso' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    //surveillance
...
if (isset($_POST['utilisateur_id'])) {
    ...
    mysqli_query($conn, "UPDATE persos SET utilisateur_id = '$utilisateur_id' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    echo "<script language='javascript' type='text/javascript' >document.location='" . $_SESSION['temps']['page'] . "'</script>";
    exit;
}
...
if (isset($_POST['change_attribute'])) {
    ...
    mysqli_query($conn, "UPDATE persos SET pnj = '$pnj', mortel = '$mortel' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    //echo "<script language='javascript' type='text/javascript' >document.location='".$_SESSION['temps']['page']."'</script>";
        exit;
}
...
if (isset($_POST['icone_id'])) {
    ...
    mysqli_query($conn, "UPDATE persos SET icone_id = '$icone_id' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    echo "<script language='javascript' type='text/javascript' >document.location='" . $_SESSION['temps']['page'] . "'</script>";
    exit;
}
...
if (isset($_POST['galon_id'])) {
    ...
    mysqli_query($conn, "UPDATE persos SET galon_id = '$galon_id' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    //surveillance
...
if (isset($_POST['race'])) {
    ...
    if (isset($_POST['nom_race'])) {
        ...
        if ($nom_race != '') {
            mysqli_query($conn, "UPDATE persos SET nom_race = '$nom_race' WHERE id = '$id_perso'") or die(mysqli_error($conn));
        } else {
            mysqli_query($conn, "UPDATE persos SET nom_race = NULL WHERE id = '$id_perso'") or die(mysqli_error($conn));
        }
    }
...
if (isset($_POST['sup_id'])) {
    $sup_id = $_POST['sup_id'];
    mysqli_query($conn, "UPDATE persos SET superieur_id = '$sup_id' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    //surveillance
...
if (isset($_POST['mortel'])) {
    $mortel = $_POST['mortel'];
    mysqli_query($conn, "UPDATE persos SET mortel = '$mortel' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    //surveillance
...
if (isset($_POST['date'])) {
    $date = $_POST['date'];
    mysqli_query($conn, "UPDATE persos SET date_tour = '$date' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    echo "<script language='javascript' type='text/javascript' >document.location='" . $_SESSION['temps']['page'] . "'</script>";
    exit;
}
...
if (isset($_POST['options'])) {
    ...
    mysqli_query($conn, "UPDATE persos SET options = '$options' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    echo "<script language='javascript' type='text/javascript' >document.location='" . $_SESSION['temps']['page'] . "'</script>";
    exit;
}
...
//-- Mdj
if (isset($_POST['mdj'])) {
    $mdj = mysqli_real_escape_string($conn, $_POST['mdj']);
    $time = ceil(time() / 119);
    $sql = "REPLACE INTO  `ewo`.`persos_mdj` (`id` ,`perso_id` ,`date` ,`message`)
			VALUES ('$time',  '$id_perso', CURRENT_TIMESTAMP ,  '$mdj');";
    mysqli_query($conn, $sql) or die(mysqli_error($conn));
    mysqli_query($conn, "UPDATE persos SET mdj = '$mdj' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    echo "<script language='javascript' type='text/javascript' >document.location='" . $_SESSION['temps']['page'] . "'</script>";
    exit;
}
...
if (isset($_POST['signature'])) {
    ...
    mysqli_query($conn, "UPDATE persos SET signature = '$signature' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    echo "<script language='javascript' type='text/javascript' >document.location='" . $_SESSION['temps']['page'] . "'</script>";
    exit;
}
...
if (isset($_POST['background'])) {
    ...
    mysqli_query($conn, "UPDATE persos SET background = '$background' WHERE id = '$id_perso'") or die(mysqli_error($conn));
    echo "<script language='javascript' type='text/javascript' >document.location='" . $_SESSION['temps']['page'] . "'</script>";
    exit;
}
...
if (isset($_POST['pi'])) {
    mysqli_query($conn, "UPDATE caracs SET px = '" . $_POST['px'] . "', 
	pi = '" . $_POST['pi'] . "', 
	pv = '" . $_POST['pv'] . "', 
	niv_pv = '" . $_POST['niv_pv'] . "', 
	...
	niv_perception = '" . $_POST['niv_perception'] . "'
		WHERE perso_id = '$id_perso'") or die(mysqli_error($conn));

    mysqli_query($conn, "UPDATE caracs_alter SET 
    ...
    /*mysqli_query($conn, "UPDATE caracs_alter_mag SET
    ...
    alter_perception = '".$_POST['perception_mag']."'
        WHERE perso_id = '$id_perso' LIMIT 1")or die (mysqli_error($conn));*/

    mysqli_query($conn, "UPDATE caracs_alter_plan SET 
