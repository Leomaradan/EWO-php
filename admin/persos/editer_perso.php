...
if (isset($_POST['id_perso'])) {
    $id = mysqli_real_escape_string($conn, $_POST['id_perso']);
    $ok = 1;
}
if (isset($_GET['id'])) {
...
if (isset($_POST['pseudo_perso'])) {
    $pseudo = mysqli_real_escape_string($conn, $_POST['pseudo_perso']);
    $ok = 1;
}
...
if ($ok == 1) {
    if (!empty($pseudo)) {
        ...
        $resultat = mysqli_query($conn, $info) or die(mysqli_error($conn));
...
//-- Caracs personnages
    ...
    $carac_alter_mag_detail = mysqli_query($conn, $sql) or die(mysqli_error($conn));
...
//-- Nom utilisateur propriétaire du personnage
    ...
    $result = mysqli_query($conn, $noms) or die(mysqli_error($conn));
...
//-- Position et plan du personnage
    ...
    $resultat1 = mysqli_query($conn, $sql) or die(mysqli_error($conn));
    ...
    <td></td><td>
        <form name='race' action="edition_perso.php" method="post">
            <b>Race :</b><br />
                <select name="race">
                    <?php
                    $reponse = mysqli_query($conn, "SELECT race_id,nom FROM races WHERE grade_id = -2");
    ...
    <td></td><td>
        <form name='grade' action="edition_perso.php" method="post">
            <b>Grade :</b><br />
                <select name="grade">
                    <?php
                    $reponsegrade = mysqli_query($conn, "SELECT grade_id,nom FROM races WHERE race_id='$race' AND grade_id!=-2");
    ...
    <td></td><td>
        <form name='sup' action="edition_perso.php" method="post">
            <b>Supérieur d'affiliation :</b><br />
                <select name="sup_id">
                    <?php
                    $reponsesup = mysqli_query($conn, "SELECT id,nom FROM persos WHERE grade_id=5");
        ...
        <form name='option' action="edition_perso.php" method="post">
          ...
          <tr>
            <td>
                    <select name="carte">
                        <?php
                        $carte = mysqli_query($conn, "SELECT id,nom FROM cartes");
