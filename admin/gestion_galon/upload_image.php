...
$prefix     = "galons/" . $grade . "/";
// Chemin du dépôt en fonction de la race.
...
// Si c'est OK, on teste l'upload
            ...
            // Si upload OK
                        ...
                        //-- Mise à jour de la base avec le lien de l'avatar
                            $sql = mysqli_query($ewo, "INSERT INTO icone_galons (id, grade_id, icone_url) VALUES ('','" . $_POST['grade'] . "', '$cible')");
