                ...
                <select name="grade">
                    ...
                    for ($inc = -1; $inc <= 5; $inc++) {
                        if ($inc == 0) {
                            ...
                            echo "<option value='" . $inc . "'>Grade " . $inc . "</option>";
                        }
                    }
                    ?>
                </select>
...
<form action="index.php" method="post" name="race">
    Choisissez une race :
        ...
        $liste_race = mysqli_query($conn, "SELECT race_id,nom FROM races WHERE grade_id=0");
...
if (isset($_POST['race_id'])) {
    ...
    $resultat = mysqli_query($conn, $races) or die(mysqli_error($conn));
    while ($race = mysql_fetch_array($resultat)) {
        ...
        $result = mysqli_query($conn, $icones) or die(mysqli_error($conn));
