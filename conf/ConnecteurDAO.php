...
class ConnecteurDAO
{
    ...
    public function exec($query)
    {
        try {
            ...
            echo "Une erreur à été générée dans la base de données : " . $e->getMessage();
            trigger_error("Une erreur à été générée dans la base de données", E_USER_ERROR);
            // Inscription de l'erreur dans un fichier log ? $e->getMessage();
        }
    }
     ...
     */
    public function fetchAssoc($pdoStatement = null)
    {
        return $this->fetch($pdoStatement, PDO::FETCH_ASSOC);
    }
    public function fetchRow($pdoStatement = null)
    {
        return $this->fetch($pdoStatement, PDO::FETCH_NUM);
    }
    public function fetchArray($pdoStatement = null)
    {
     ...
     */
    public function fetchAllAssoc($pdoStatement = null)
    {
        return $this->fetchAll($pdoStatement, PDO::FETCH_ASSOC);
    }
    public function fetchAllRow($pdoStatement = null)
    {
        return $this->fetchAll($pdoStatement, PDO::FETCH_NUM);
    }
    public function fetchAllArray($pdoStatement = null)
    {
