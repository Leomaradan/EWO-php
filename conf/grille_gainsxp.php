 ...
 */
    ...
    $gain['esquiver_cible']['esquiver'] = 2; // ajoute +2 xp � la diff�rence de rang
    ...
    $gain['esquiver_zone']['esquiver'] = 0; // Pas de modificateur par rapport � la diff�rence de rang
...
// Full pv ou pas la r�paration pex quand m�me. Voire �a pex encore plus (?).
