...
function serievent($array)
{
    ...
    foreach ($array as $key => $value) {
        $retour = $retour . $key . '|' . mysqli_real_escape_string($conn, $value) . '|';
    }
    return $retour;
}
    ...
    <img src='<?php echo SERVER_URL; ?>/images/<?php echo $url; ?> ' alt='avatar'>
          ...
          //affichage eléments prive
                if ($typeEvent == "prive") {
                    ...
                    if (isset($champs['exp_def'])) {
                        echo "<br/> exp : " . $champs['exp_def'];
                    }
                    if (isset($champs['exp_att'])) {
                        echo "<br/> exp : " . $champs['exp_att'];
                    }
                }
                ?></td>
</tr>
    ...
    <img src='<?php echo SERVER_URL; ?>/images/<?php echo $url; ?> ' alt='avatar'>
            ...
            if ($champs['attaquant'] == $id_perso) {
              ...
              //création de la liste des victimes
                ...
                if ($liste_vict != "") {
                    echo $liste_vict . " ont été touché.<br/>";
                }
      ...
      //création de la liste des destruction
                ...
                if ($liste_destruction != "") {
                    echo $liste_destruction . " ont été détruit.<br/>";
                }
