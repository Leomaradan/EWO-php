...
if ($perso_id == -1 || isset($_GET['world'])) {
    $event_perso = "Liste des dernières actions dans le monde";
} else {
    $event_perso = 'Liste des actions de ' . nom_perso($perso_id)/*.' depuis les '.EventFormatter::$NB_JOUR.' derniers jours'*/;
}
...
<?php if (!isset($_GET['world']) && $perso_id >= 1) {
    ?><div id="CV" class="conteneur_titre"
