...
if ($gameplay == "T4") {
    ...
    if (
        !isset($_POST['sexe2']) || ($_POST['sexe2'] != '1' && $_POST['sexe2'] != '2' && $_POST['sexe2'] != '3') ||
...
function checkClass($gameplay, $race)
{
    ...
    if ($gameplay == 'T4') {
        if (
            !isset($_POST['choixclasse2' . $race]) || $_POST['choixclasse2' . $race] == '' ||
...
switch ($race) {
    ...
    //$forum->setMatricule($perso1->Nom, $perso1->Mat);
