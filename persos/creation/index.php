...
<?php if ($peutCreer) { //DEBUT PEUTCREER  ?>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <input type="button" class="choixgameplay" name="T3" value="Chuis trop un roxxor!" <?php if (!$creationT3) {
                                echo 'disabled';
                                                                                                               } ?>/>
                        </td>   
                        <td>                
                            ...
                            <input type="button" class="choixgameplay" name="T4" value="L'union fait la Force!" <?php if (!$creationT4) {
                                echo 'disabled';
                                                                                                                } ?>/>
                        </td>                        
                    </tr>
    ...
    <?php } ?>
            ...
            <label for="classe1">Classe : 
                <?php if ($camp == null || $camp == "humain") {
                    echo \conf\Helpers::getSelectOption($liste[1], "choixclasse1humain", null, "Sélectionnez votre classe");
                } ?>        
                <?php if ($camp == null || $camp == "ange") {
                    echo \conf\Helpers::getSelectOption($liste[3], "choixclasse1ange", null, "Sélectionnez votre classe");
                } ?>
                <?php if ($camp == null || $camp == "demon") {
                    echo \conf\Helpers::getSelectOption($liste[4], "choixclasse1demon", null, "Sélectionnez votre classe");
                } ?>
            </label>
            <div id="perso2" class="perso_sup">
                ...
                <?php if ($camp == null || $camp == "humain") {
                    echo \conf\Helpers::getSelectOption($liste[1], "choixclasse2humain", null, "Sélectionnez votre classe");
                } ?>        
                <?php if ($camp == null || $camp == "ange") {
                    echo \conf\Helpers::getSelectOption($liste[3], "choixclasse2ange", null, "Sélectionnez votre classe");
                } ?>
                <?php if ($camp == null || $camp == "demon") {
                    echo \conf\Helpers::getSelectOption($liste[4], "choixclasse2demon", null, "Sélectionnez votre classe");
                } ?>                    
                </label>
            </div>
            ...
            <div id="perso3" class="perso_sup">
                ...
                <?php if ($camp == null || $camp == "humain") {
                    echo \conf\Helpers::getSelectOption($liste[1], "choixclasse3humain", null, "Sélectionnez votre classe");
                } ?>        
                <?php if ($camp == null || $camp == "ange") {
                    echo \conf\Helpers::getSelectOption($liste[3], "choixclasse3ange", null, "Sélectionnez votre classe");
                } ?>
                <?php if ($camp == null || $camp == "demon") {
                    echo \conf\Helpers::getSelectOption($liste[4], "choixclasse3demon", null, "Sélectionnez votre classe");
                } ?>                    
                </label>
            </div>
            ...
            <div id="perso4" class="perso_sup">
                ...
                <?php if ($camp == null || $camp == "humain") {
                    echo \conf\Helpers::getSelectOption($liste[1], "choixclasse4humain", null, "Sélectionnez votre classe");
                } ?>        
                <?php if ($camp == null || $camp == "ange") {
                    echo \conf\Helpers::getSelectOption($liste[3], "choixclasse4ange", null, "Sélectionnez votre classe");
                } ?>
                <?php if ($camp == null || $camp == "demon") {
                    echo \conf\Helpers::getSelectOption($liste[4], "choixclasse4demon", null, "Sélectionnez votre classe");
                } ?>                    
                </label>
            </div>                
