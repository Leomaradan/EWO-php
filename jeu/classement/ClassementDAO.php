...
abstract class ClassementDAO extends ConnecteurDAO
{
    ...
    */
    ...
    public const ANGE = 1;
    public const HUMAIN = 2;
    public const DEMON = 4;
    public const AILE = 5;
    public const PARIA = 8;
    public const TOUS = 15;

    // Ordre du classement. Valeur bool�enne
    public const CROISSANT = true;
    public const DECROISSANT = false;

    // Tri par grades, et �ventuellement par galons. Valeur binaire
    public const SANSGRADE = 0;
    public const GRADESANSGALON = 1;
    public const GRADEGALON = 3;

    // Types de classements
    public const XP = 1;
    public const MORT = 2;
    public const MEURTRE = 3;
    public const TAILLECV = 4; /* La taille du CV = diff�rence entre morts et meutre */
    public const SURVIE = 5; /* Le temps depuis la derni�re mort */
    public const FAMILLE = 6; /* Classement des familles, avec valeur moyenne des xp */
    public const MOSTWANTED = 7; /* Classement des familles, avec valeur moyenne des xp */
    public const AUTOGOAL = 8; /* Classement des familles, avec valeur moyenne des xp */
    public const REGICIDE = 9; /* Classement des familles, avec valeur moyenne des xp */
    public const SUPERMAN = 10; /* Classement des familles, avec valeur moyenne des xp */
    ...
    */
    ...
    protected function archiveClassement()
    {
        ...
        /*if ($refresh) {
                ...
                $sql = "REPLACE INTO classement SELECT * FROM classement_view;";
                $this->exec($sql);
        }*/
    }

    abstract public function prepareClassement();
...
/*
    ...
    */
    ...
    abstract public function compteLignes();

    abstract public function cherchePositionMat($mat);
