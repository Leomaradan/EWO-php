...
if (isset($_POST['perso_id'])) {
    $param['id'] = mysqli_real_escape_string($conn, $_POST['perso_id']);
} elseif (isset($_GET['perso_id'])) {
    $param['id'] = mysqli_real_escape_string($conn, $_GET['perso_id']);
} else {
    $param['id'] = 0;
...
if (!empty($_POST['race'])) {
    $param['race'] = mysqli_real_escape_string($conn, $_POST['race']);
} elseif (!empty($_GET['race'])) {
    $param['race'] = mysqli_real_escape_string($conn, $_GET['race']);
} else {
    $param['race'] = 0;
}
