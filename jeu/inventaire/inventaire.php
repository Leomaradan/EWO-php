...
<div class='draghandle conteneur_titre'>Inventaire <span id="block-6-button" class='curspointer' onclick="cacherblock('block-6',this.id);"><?php if ($visiblock['6'] == 1) {
    echo '[-]';
                                                                                                                                           } else {
                                                                                                                                               echo '[+]';
                                                                                                                                           } ?></span></div>
<div id="layer-block-6" style='display:<?php if ($visiblock['6'] == 1) {
    echo 'block';
                                       } else {
                                           echo 'none';
                                       } ?>'>
...
<?php if ($is_spawn) {
    ?>
                ...
                $resultat = mysqli_query($conn, $inventaires) or die(mysqli_error($conn));
                $p = 1;
                $cout = 0;
                $poid = 0;
