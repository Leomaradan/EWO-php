...
$resultat = mysql_fetch_array(mysqli_query($conn, $sql)) or die(mysqli_error($conn));
...
if ($pos = mysql_fetch_array($resultat)) {
    ...
    if ($mortel == 1) {
        ...
        mysqli_query($conn, "UPDATE persos SET mortel = -1 WHERE id='$perso_id'") or die(mysqli_error($conn));
